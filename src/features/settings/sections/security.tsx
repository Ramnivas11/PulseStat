    ...
    <Card className="relative hover:border-primary/50 transition-colors duration-200">
      <CardHeader className="border-b border-border bg-muted/10 pb-4">
        <div className="flex flex-col">
          ...
          <span className="font-heading text-base font-semibold tracking-tight text-white block">Security</span>
        </div>
      </CardHeader>
      <CardContent className="pt-6">
        <div className="space-y-6">
          <div>
            <h4 className="font-mono text-xs uppercase text-white font-bold mb-1">Password</h4>
          ...
          <div>
            <h4 className="font-mono text-xs uppercase text-white font-bold mb-1">Active Sessions</h4>
            ...
            <div className="mt-3">
              <Button variant="ghost" size="sm" className="font-mono text-[10px] uppercase text-muted-foreground hover:text-white">SIGN_OUT_OTHER_SESSIONS</Button>
            </div>
          </div>
        </div>
      </CardContent>
