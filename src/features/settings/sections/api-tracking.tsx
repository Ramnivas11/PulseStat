    ...
    <Card className="relative hover:border-primary/50 transition-colors duration-200">
      <CardHeader className="border-b border-border bg-muted/10 pb-4">
        <div className="flex flex-col">
          ...
          <span className="font-heading text-base font-semibold tracking-tight text-white block">API & Tracking Keys</span>
        </div>
      </CardHeader>
      <CardContent className="pt-6">
        <div className="space-y-6">
          <div>
            <h4 className="font-mono text-xs uppercase text-white font-bold mb-1">Public API Key</h4>
          ...
          <div>
            <h4 className="font-mono text-xs uppercase text-white font-bold mb-1">Ingestion Endpoint</h4>
            ...
            <div className="mt-3 font-mono text-xs text-white bg-muted/20 border border-border p-3">
