      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              PulseStat is cookie-free by design. Our tracking script does not set any cookies on your visitors&apos; browsers and does not track users across websites.
            </p>
            <p className="mb-4">
              We use a rotating session hash derived from the visitor&apos;s IP address and user-agent to identify unique sessions without persisting any identifiers. This hash changes every 24 hours and cannot be used to track users across sessions.
            </p>
          </section>
